...
{
	const int number_of_schedules=10;		// количество особей в популяции
	SCHEDULE mas[number_of_schedules],mas2[number_of_schedules],mas3[number_of_schedules]; // - инициализация расписаний
	...
	int stats[number_of_schedules],max,nmax,iter;  // - массив статистик. сейчас - количество свободных мест в аудиториях
	iter=0;
